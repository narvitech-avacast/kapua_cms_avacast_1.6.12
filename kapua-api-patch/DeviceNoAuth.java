...
public class DeviceNoAuth extends AbstractKapuaResource {
    ...
    private GatewayConfigModel buildGatewayConfigModel(Device device, SystemSetting systemSetting)
        ...
        // gateway.broker.port / gateway.broker.scheme allow overriding the external-facing
        // GatewayConfig URL independently of broker.scheme, which also controls the
        // internal transport connector (port 1893) and must stay as "tcp".
