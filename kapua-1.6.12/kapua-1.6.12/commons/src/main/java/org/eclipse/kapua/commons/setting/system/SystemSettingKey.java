...
public enum SystemSettingKey implements SettingKey {
    ...
    /**
     * Broker external MQTT port (used in gateway config for device connections)
     */
    BROKER_PORT("broker.mqtt.port"),
    /**
     * Broker external MQTT password (used in gateway config for device connections)
     */
    BROKER_PASSWORD("broker.mqtt.password"),
    /**
